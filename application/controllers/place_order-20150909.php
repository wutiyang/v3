...
class Place_order extends Dcontroller {
	...
	public function __construct(){
		...
		//国家省份信息
		$this->load->model('countryprovincemodel','province');
		$all_province_list = $this->province->countryProvinceList();
		$all_country_list = $this->province->countryList();
		$this->_view_data['province_list'] = json_encode($all_province_list);
		$this->_view_data['country_list'] = $all_country_list;
	}
