...
class Place_order extends Dcontroller {
	...
	public function index(){
		...
		//********************汇率****************start
		$new_currency_code = currentCurrency();//AUD
		//echo $new_currency_code."====".$this->currency;die;
		$currency = "$";
		if($this->currency_format){
		...
		$this->_view_data['total_rewards'] = $new_currency_code." ".$currency." ".$this->total_rewards;
		//***************rewords**************end
	...
	public function ajaxFresh($type=null){
		...
		//****************rewards start****************
		$return_data['AvailableBalanceprice'] = $currency_code." ".$this->currency." ".$this->total_rewards;
		if($this->cart_noempty){
	...
	public function paypal_ec(){
		...
		//***************rewords**************start
		$this->_view_data['total_rewards'] = $currency_code." ".$currency." ".$this->total_rewards;
		//***************rewords**************end
		...
		//$this->_view_data['currency'] = $currency;
		$this->_view_data['new_currency_code'] = $currency_code;
	...
	private function _get_shipping_option_data($address_country,$cart_data,$cart_weight_info,$track=0,$selected_shipping_id = 0){
		if(!empty($address_country)){
			...
			if($shipping_options_list['exists_rule']==1){
				...
				//echo "<pre>fdfdrereew";print_r($able_shipping_options);die;
