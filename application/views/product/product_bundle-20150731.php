<div class="con">
            <ul>
                                ...
                                <div class="select-block" title="<?php echo $bundle_attr_value_v['complexattr_lang_title']?>">
		                            ...
		                            <div class="drop-box">
                                        <ul class="drop-content drop-list">
                                            <li class="hide" attrid="default"><a href="javascript:;">Select Color</a></li>
                                            <?php 
                ...
                <li class="selectModule">
                    <div class="pro-list-block">
                        <div class="p-pic">
                            <a title="<?php echo $bundle_pro_v['product_description_name']?>" href="<?php echo genURL($bundle_pro_v['product_url'])?>"><img alt="" src="<?php echo PRODUCT_IMAGE_URL."160x160/".$bundle_pro_v['product_image']?>" width="160" height="160"></a>
                        </div>
                        <div class="p-name current">
                            <i class="icon-ipt"></i><a title="<?php echo $bundle_pro_v['product_description_name']?>" href="<?php echo genURL($bundle_pro_v['product_url'])?>"><?php echo $bundle_pro_v['product_description_name']?></a>
                        </div>
                        <div class="p-price">
                ...
                <li class="list-tocart" id="countPrice">
                    <strong>Total Price<span class="count"><?php echo $currency?><i>144.00</i></span></strong>
                    <a href="javascript:;"  class="btnorg35" id="listToCart">Add Selected Items to Cart</a>
                    <strong>Save<span class="save"><?php echo $currency?><i>14.00</i>!</span></strong>
                </li>
            </ul>
        </div>