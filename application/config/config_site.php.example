...
define('DISABLE_CI_ERROR_REPORT',false);
...
define('PRODUCT_IMAGEXL_URL','http://img6.eachbuyer.com/500x500/');
define('PRODUCT_IMAGEL_URL','http://img6.eachbuyer.com/450x450/');
define('PRODUCT_IMAGEM_URL','http://img6.eachbuyer.com/350x350/');
define('PRODUCT_IMAGES_URL','http://img6.eachbuyer.com/100x100/');
